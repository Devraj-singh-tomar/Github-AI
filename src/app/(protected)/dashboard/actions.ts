...
export async function askQuestion(question: string, projectId: string) {
  ...
  (async () => {
    const { textStream } = await streamText({
      ...
      prompt: `
      You are a AI code assistant who answers questions about  the codebase. Your target audiece is a technical intern w
        AI assistant Is a brand newpowerful human like artificial intelligence.
        AI is a wealth behavior and well-mannered individual.
        ...
        If The question is asking about code or the specific file AI will provide a detailed answer giving step by step instruction about code or files
        START CONTEXT BLOCK
        ${context}
