...
const IssuesList = ({ meetingId }: Props) => {
  ...
  if (isLoading || !meeting) return <Loader2Icon className="animate-spin" />;
        ...
        <div className="mx-auto flex max-w-2xl items-center justify-between gap-x-8 border-b pb-6 lg:mx-0 lg:max-w-none">
          <div className="flex items-center gap-x-6">
            ...
            <h1>
              ...
              <div
                title={meeting.name}
                className="line-clamp-1 text-base font-semibold leading-6 text-gray-900"
              >
                {meeting.name}
              </div>
            </h1>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <p className="text-gray-700">{issue.headline}</p>

            <blockquote className="border-l-4 border-gray-300 bg-gray-50 p-2">
